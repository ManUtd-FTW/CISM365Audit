<#
Helper: Get-CurrentTenant

Defines a single, read-only helper that attempts to infer tenant info from an
already-authenticated Graph/Exchange context. This file contains only the
function definition and performs no work at file scope.
#>
